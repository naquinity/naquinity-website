...
export const metadata: Metadata = {
  ...
  description: 'Website Resmi Organisasi Mahasiswa PSTI 24 - Navindra Equinox Unity. Informasi seputar kegiatan, program, dan pencapaian mahasiswa.',
  ...
  openGraph: {
    ...
    description: 'Website Resmi Organisasi Mahasiswa PSTI 24. Bersama Membangun Masa Depan Teknologi.',
  ...
  twitter: {
    ...
    description: 'Website Resmi Organisasi Mahasiswa PSTI 24',
