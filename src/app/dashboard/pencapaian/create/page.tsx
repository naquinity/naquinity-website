...
import { createPencapaian } from '@/actions/pencapaian'
import Link from 'next/link'
import { useActionState, useState, useRef } from 'react'

export default function CreatePencapaianPage() {
    const [state, action, isPending] = useActionState(createPencapaian, null)
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                ...
                <span className="material-symbols-outlined !text-sm">chevron_right</span>
                <span className="font-bold text-slate-800">Tambah Pencapaian</span>
            </div>
